...
def sendmail(mail_title, receiver, sender, username, password):
    ...
    f = open(r"C:/autoInterface/apache-jmeter-5.2/report/html/epjsReport.html",
             'rb')
    mail_body = f.read()
    f.close()
    ...
    attachment = MIMEApplication(
        open(
            r'C:/autoInterface/apache-jmeter-5.2/report/html/epjsReport_detail.html',
            'rb').read())
    #重命名文件
...
if __name__ == '__main__':
    ...
    receiver = 'fanxiaohuan@yinongt.com'
    # 发送邮箱的用户名和密码
    ...
    # 邮件主题
    mail_title = 'eojs接口测试报告: ' + getRunResult
